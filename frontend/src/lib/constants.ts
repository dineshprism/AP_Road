...
export const DRIVER_RELATED_CAUSES = [
...
export const VEHICLE_CONDITION_CAUSES = [
...
export const ROAD_CULVERTS_CAUSES = [
...
export const ROAD_JUNCTIONS_CAUSES = [
...
export const ROAD_MEDIAN_CAUSES = [
  "Improper median.",
  "Broken median.",
  "Absence of Median.",
];

export const ROAD_NATURE_CAUSES = [
...
export const ROAD_SIGNAGES_CAUSES = [
