-- Sample accident data with CORRECT user IDs matching the system
...
(gen_random_uuid(), 'visakhapatnam-user-id', 'Visakhapatnam', 'NH-16 near Gopalapatnam', 'Visakhapatnam Rural', 'Gopalapatnam PS', 'FIR/123/2024', 'National Highway', '2024-01-15', '14:30', '17.7152, 83.2483', 2, 3,
...
(gen_random_uuid(), 'visakhapatnam-user-id', 'Visakhapatnam', 'Beach Road near RK Beach', 'Visakhapatnam Urban', 'Beach Road PS', 'FIR/124/2024', 'City Road', '2024-02-20', '20:15', '17.7245, 83.2678', 1, 2,
...
-- Krishna (Vijayawada) accidents
(gen_random_uuid(), 'vijayawada-user-id', 'Krishna', 'NH-65 near Benz Circle', 'Vijayawada Urban', 'Patamata PS', 'FIR/125/2024', 'National Highway', '2024-03-10', '08:45', '16.5062, 80.6480', 3, 1,
...
(gen_random_uuid(), 'vijayawada-user-id', 'Krishna', 'Eluru Road near Auto Nagar', 'Vijayawada Rural', 'Autonagar PS', 'FIR/126/2024', 'State Highway', '2024-04-05', '17:20', '16.5124, 80.6521', 1, 4,
...
-- Guntur accidents
(gen_random_uuid(), 'guntur-user-id', 'Guntur', 'NH-16 near Chilakaluripet', 'Guntur Rural', 'Chilakaluripet PS', 'FIR/130/2024', 'National Highway', '2024-08-22', '16:30', '16.1645, 80.2584', 2, 5,
...
-- Chittoor accidents
(gen_random_uuid(), 'chittoor-user-id', 'Chittoor', 'Alipiri Road near Foot Hills', 'Tirupati Urban', 'Alipiri PS', 'FIR/127/2024', 'Ghat Road', '2024-05-12', '06:30', '13.6587, 79.4187', 2, 2,
...
-- Anantapur accidents
(gen_random_uuid(), 'anantapur-user-id', 'Anantapur', 'NH-44 near Uravakonda', 'Anantapur Rural', 'Uravakonda PS', 'FIR/128/2024', 'National Highway', '2024-06-18', '22:45', '14.7452, 77.6218', 1, 3,
...
-- Kurnool accidents
(gen_random_uuid(), 'kurnool-user-id', 'Kurnool', 'NH-40 near Nandyal', 'Kurnool Rural', 'Nandyal PS', 'FIR/129/2024', 'National Highway', '2024-07-08', '11:20', '15.4846, 78.4832', 4, 2,
...
-- Nellore accidents
(gen_random_uuid(), 'nellore-user-id', 'Nellore', 'NH-5 near Nellore Bypass', 'Nellore Urban', 'Nellore Bypass PS', 'FIR/131/2024', 'National Highway', '2024-09-14', '09:15', '14.4426, 79.9865', 1, 2,
