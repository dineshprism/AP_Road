    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,#274b93_0%,#132b5e_36%,#08173f_100%)]">
      ...
      <div className="flex min-h-[calc(100vh-4px)] flex-col overflow-y-auto px-4 py-4 lg:px-6">
        ...
        <div className="container mx-auto flex flex-1 flex-col py-2">
          <div className="grid w-full grid-cols-1 gap-5 lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] lg:items-start">
            <Card className="hidden min-h-[480px] overflow-hidden border-0 bg-white/95 shadow-2xl lg:flex lg:flex-col">
              ...
              <CardHeader className="shrink-0 border-b border-slate-200 bg-[linear-gradient(135deg,#ffffff_0%,#eef4ff_100%)] pb-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <a href={memoRoadSafetyPdf} download="memo_road_safety.pdf">
                    <Button type="button" variant="outline" className="border-primary/20 bg-white text-sm">
              ...
              <CardContent className="min-h-0 flex-1 bg-slate-100 p-3">
                <div className="h-full min-h-[360px] overflow-auto rounded-xl border border-slate-200 bg-white shadow-inner">
                  <iframe
            ...
            <div className="flex items-start justify-center lg:justify-end">
              <Card className="w-full max-w-2xl overflow-visible rounded-[24px] border-0 shadow-2xl">
                <div className="h-1.5 bg-gradient-to-r from-[#ff9933] via-white to-[#138808]" />
                <CardHeader className="bg-gradient-to-b from-primary/5 to-transparent pb-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground sm:text-base">Access the DRSC Portal</p>
                </CardHeader>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={username} onValueChange={setUsername}>
                        ...
                        <SelectContent position="popper" side="bottom" align="start" collisionPadding={48}>
                          <SelectGroup>
                            <SelectLabel>State roles</SelectLabel>
                            <SelectItem value="DGP" className="font-semibold text-primary">
                              DGP
                            </SelectItem>
                            <SelectItem value="ADGP" className="font-semibold text-primary">
                              ADGP
                            </SelectItem>
                          </SelectGroup>
                          <SelectSeparator />
